...
- When a button label is EMPTY, that button is not displayed.
...
| `LabelCancel` | `string`        | Label on the cancel button. Button hidden when empty.                                                                                                              |
| `LabelNo`     | `string`        | Label on the negative button. Button hidden when empty.                                                                                                            |
| `LabelYes`    | `string`        | Label on the affirmative button. Button hidden when empty.                                                                                                         |
